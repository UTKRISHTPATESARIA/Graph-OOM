 ...
 public:
  ...
  void run_current_test(std::tuple<PageRank_Usecase const&, input_usecase_t const&> const& param)
  {
    ...
    /*
      ...
      available_gpu_mem = get_gpu_memory()[0]*1024*1024
      perc_of_oversub = int(sys.argv[1])
      reserve_memory_bytes = (perc_of_oversub*available_gpu_mem/100)
      buf = rmm.DeviceBuffer(size=reserve_memory_bytes)
      rmm.reinitialize(managed_memory=True)

    */

    //rmm::cuda_stream_view stream = rmm::cuda_stream_view{};
    //rmm::device_buffer device_buff(1UL<<30, stream);
...
using TestsPageRankFile = Tests_PageRank<cugraph::test::File_Usecase>;
using Tests_PageRank_Rmat = Tests_PageRank<cugraph::test::Rmat_Usecase>;

// FIXME: add tests for type combinations
TEST_P(TestsPageRankFile, CheckInt32Int32FloatFloat)
{
...
TEST_P(TestsPageRankFile, CheckInt32Int64FloatFloat)
{
...
INSTANTIATE_TEST_SUITE_P(file_test,
                         ...
                         ::testing::Combine(
                           ...
                           ::testing::Values(cugraph::test::File_Usecase("/home/utkrisht/cugraph/datasets/r700m_twitter-2010.csv"))));
